...
export default function Services() {
  return (
    <section id="servicios" className="relative py-24 px-4 sm:px-6 lg:px-8 bg-white">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {services.map((service) => (
            <div key={service.title} className="glass-card p-8 rounded-lg">
              <div className={`w-12 h-12 rounded-lg flex items-center justify-center ${service.iconColor} mb-6 ${service.iconBg}`}>
                {service.icon}
              </div>
