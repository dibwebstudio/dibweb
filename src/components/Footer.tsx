      ...
      <div className="max-w-7xl mx-auto">
          ...
          <div>
            ...
            <ul className="space-y-2.5">
              {["Landing Pages", "Corporativos", "E-commerce", "SEO & Marketing", "Meta Ads", "Sistemas ERP"].map((s) => (
                <li key={s}><a href="#servicios" className="text-sm text-neutral-400 hover:text-white transition-colors">{s}</a></li>
              ))}
            </ul>
          </div>
          <div>
        ...
        <div className="border-t border-neutral-800 pt-8 flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-6">
            <a href="/politicas" className="text-neutral-500 hover:text-white transition-colors text-sm">Privacidad</a>
            <a href="/terminos" className="text-neutral-500 hover:text-white transition-colors text-sm">Términos</a>
