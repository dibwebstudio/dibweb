    ...
    <footer className="border-t border-gray-200 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            <h4 className="font-semibold text-gray-900 text-sm mb-4">Servicios</h4>
            <ul className="space-y-2.5">
              <li><a href="#servicios" className="text-sm text-gray-500 hover:text-gray-900 transition-colors">Landing Pages</a></li>
              <li><a href="#servicios" className="text-sm text-gray-500 hover:text-gray-900 transition-colors">Sitios Corporativos</a></li>
              <li><a href="#servicios" className="text-sm text-gray-500 hover:text-gray-900 transition-colors">E-commerce</a></li>
              <li><a href="#servicios" className="text-sm text-gray-500 hover:text-gray-900 transition-colors">SEO & Marketing</a></li>
            </ul>
          </div>
