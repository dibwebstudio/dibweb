  ...
  return (
    <section className="py-14 px-4 sm:px-6 lg:px-8 bg-slate-50 border-y border-slate-100">
      <div className="max-w-7xl mx-auto">
        <p className="text-center text-slate-400 text-xs uppercase tracking-widest mb-8">Confían en nosotros</p>
        <div className="flex flex-wrap items-center justify-center gap-x-12 gap-y-6">
          {[
            ...
            <div key={t.name} className="flex items-center gap-2 text-slate-400 hover:text-slate-600 transition-colors">
