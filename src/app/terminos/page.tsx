      ...
      <main className="flex-1 bg-white min-h-screen">
        <section className="pt-32 pb-20 px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto">
            <Link href="/" className="inline-flex items-center gap-2 text-neutral-600 hover:text-neutral-900 text-sm mb-8 transition-colors">
            ...
            <h1 className="text-3xl sm:text-4xl font-bold text-neutral-900 mb-4">Términos y Condiciones</h1>
            <p className="text-neutral-600 mb-8">Última actualización: Enero 2025</p>
            ...
            <div className="space-y-8 text-neutral-600 leading-relaxed">
              ...
              <div>
                <h2 className="text-xl font-semibold text-neutral-900 mb-3">2. Descripción de servicios</h2>
                <p className="text-neutral-600">
              ...
              <div>
                <h2 className="text-xl font-semibold text-neutral-900 mb-3">3. Proceso de trabajo</h2>
              ...
              <div>
                <h2 className="text-xl font-semibold text-neutral-900 mb-3">4. Pagos</h2>
                <p className="text-neutral-600">
              ...
              <div>
                <h2 className="text-xl font-semibold text-neutral-900 mb-3">5. Propiedad intelectual</h2>
                <p className="text-neutral-600">
              ...
              <div>
                <h2 className="text-xl font-semibold text-neutral-900 mb-3">6. Revisions</h2>
                <p className="text-neutral-600">
              ...
              <div>
                <h2 className="text-xl font-semibold text-neutral-900 mb-3">7. Plazos de entrega</h2>
                <p className="text-neutral-600">
              ...
              <div>
                <h2 className="text-xl font-semibold text-neutral-900 mb-3">8. Soporte y mantenimiento</h2>
                <p className="text-neutral-600">
              ...
              <div>
                <h2 className="text-xl font-semibold text-neutral-900 mb-3">9. Limitación de responsabilidad</h2>
                <p className="text-neutral-600">
              ...
              <div>
                <h2 className="text-xl font-semibold text-neutral-900 mb-3">10. Cancelaciones</h2>
                <p className="text-neutral-600">
              ...
              <div>
                <h2 className="text-xl font-semibold text-neutral-900 mb-3">11. Contacto</h2>
                <p className="text-neutral-600">
