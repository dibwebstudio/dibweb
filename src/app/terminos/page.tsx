      ...
      <main className="flex-1 bg-[#0f172a] min-h-screen">
        <section className="pt-32 pb-20 px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto">
            ...
            <h1 className="text-3xl sm:text-4xl font-bold text-white mb-4">Términos y Condiciones</h1>
            ...
            <div className="space-y-8 text-slate-300 leading-relaxed">
              ...
              <div>
                <h2 className="text-xl font-semibold text-white mb-3">2. Descripción de servicios</h2>
                <p className="text-slate-400">
              ...
              <div>
                <h2 className="text-xl font-semibold text-white mb-3">3. Proceso de trabajo</h2>
              ...
              <div>
                <h2 className="text-xl font-semibold text-white mb-3">4. Pagos</h2>
                <p className="text-slate-400">
              ...
              <div>
                <h2 className="text-xl font-semibold text-white mb-3">6. Revisions</h2>
                <p className="text-slate-400">
              ...
              <div>
                <h2 className="text-xl font-semibold text-white mb-3">7. Plazos de entrega</h2>
                <p className="text-slate-400">
              ...
              <div>
                <h2 className="text-xl font-semibold text-white mb-3">8. Soporte y mantenimiento</h2>
                <p className="text-slate-400">
