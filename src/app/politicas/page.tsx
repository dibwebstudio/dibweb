          ...
          <div className="max-w-3xl mx-auto">
            ...
            <div className="space-y-8 text-slate-300 leading-relaxed">
              ...
              <div>
                ...
                <p className="text-slate-400">Utilizamos su información para:</p>
              ...
              <div>
                <h2 className="text-xl font-semibold text-white mb-3">5. Servicios de terceros</h2>
                <p className="text-slate-400">
              ...
              <div>
                <h2 className="text-xl font-semibold text-white mb-3">6. Sus derechos</h2>
                <p className="text-slate-400">
