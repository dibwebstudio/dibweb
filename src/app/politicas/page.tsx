      ...
      <main className="flex-1 bg-white min-h-screen">
        <section className="pt-32 pb-20 px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto">
            ...
            <h1 className="text-3xl sm:text-4xl font-bold text-neutral-900 mb-4">Política de Privacidad</h1>
            ...
            <div className="space-y-8 text-neutral-600 leading-relaxed">
              ...
              <div>
                ...
                <p className="text-neutral-600">Utilizamos su información para:</p>
              ...
              <div>
                <h2 className="text-xl font-semibold text-neutral-900 mb-3">3. Protección de datos</h2>
                <p className="text-neutral-600">
              ...
              <div>
                <h2 className="text-xl font-semibold text-neutral-900 mb-3">5. Servicios de terceros</h2>
                <p className="text-neutral-600">
              ...
              <div>
                <h2 className="text-xl font-semibold text-neutral-900 mb-3">7. Retención de datos</h2>
                <p className="text-neutral-600">
              ...
              <div>
                <h2 className="text-xl font-semibold text-neutral-900 mb-3">8. Cambios en esta política</h2>
                <p className="text-neutral-600">
              ...
              <div>
                <h2 className="text-xl font-semibold text-neutral-900 mb-3">9. Contacto</h2>
                <p className="text-neutral-600">
